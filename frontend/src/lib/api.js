// api.js
// ------
// High-performance API client with preloaded catalog and backend fallback.
...
export async function getPopular(n = 36, genre = null, yearMin = null, yearMax = null, language = null, offset = 0) {
  ...
  return results.length > 0 ? results : catalog.slice(0, n);
}
...
export async function getPersonalized(genres = null, vibe = null, n = 30) {
  if (BASE_URL) {
    try {
      return await fetchWithTimeout(`${BASE_URL}/personalized?n=${n}`);
    } catch {}
  }
